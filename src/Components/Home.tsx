    ...
    <main className="mt-20 flex flex-col justify-center items-center">
      ...
      <div className="flex w-full justify-center">
        ...
        <button
          ...
          className="mt-4 w-25 h-9 flex justify-center items-center gap-1 p-2 hover:cursor-pointer hover:bg-black/60 bg-black/40 text-white rounded"
        >
          <Plus size={25} />
          Agregar
        </button>
      </div>
      <div className="flex gap-1 m-10 -mt-3">
      ...
      <div className="flex justify-center gap-6 flex-wrap">
        {Array.isArray(data) &&
          data.map((note: Note) => <NoteForHome key={note._id} {...note} />)}
      </div>
