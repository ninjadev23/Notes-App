...
const Signup: React.FC = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    const response: suceessResponse | errorResponse = await refetch({ email, password, name }) as suceessResponse | errorResponse;
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form onSubmit={handleSignup} className='p-3 flex flex-col justify-center shadow-2xl shadow-black'>
        ...
        <p className='p-3'>Already have an account?<Link className="text-cyan-700" to="/login"> Log In</Link></p>
